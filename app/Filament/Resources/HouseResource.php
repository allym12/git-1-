...
class HouseResource extends Resource
{
    ...
    protected static ?string $navigationIcon = 'heroicon-s-view-grid';
                ...
                Tables\Actions\ActionGroup::make([
                    ...
                    Tables\Actions\Action::make('activate')
                        ->action(function (House $record) {
                            ...
                            Notification::make()
                                ->success()
                                ->title('Propery is activated')
                                ->body('The recently uploaded property has been activated successfully.')
                                ->actions([
                                    Action::make('view')
                                        ->button()
                                        ->color('primary')
                                        ->url(HouseResource::getUrl(), shouldOpenInNewTab: true)
                                ])
                        ...
                        ->color('success')
                        ->requiresConfirmation('Are you sure you want to activate this house?'),
                    ...
                    Tables\Actions\Action::make('deactivate')
                        ...
                        ->icon('heroicon-o-x')
                        ->color('danger')
                        ->requiresConfirmation('Are you sure you want to deactivate this house?'),
