                    ...
                    <div class="sidebar_content_details style3">
                        ...
                        <div class="sidebar_listing_list style2 mobile_sytle_sidebar mb0">
                            <div class="siderbar_widget_header">
                                <h4 class="title mb0">Find Your New land<a class="filter_closed_btn float-right" href="#"><small>x</small><span class="flaticon-close"></span></a></h4>
                            </div>
        ...
        <div class="row">
            ...
            <div class="col-xl-9">
                ...
                <div class="row">
                    @forelse($lands as $land)
                        <div class="col-lg-6 col-xl-4">
                            <div class="feat_property">
                                <div class="thumb">
                                    <a href="{{route('lands.show', $land->slug)}}">
                                        <img class="img-whp" src="{{asset('storage/'.$land->image)}}" alt="fp1.jpg">
                                    </a>
                                ...
                                <div class="details">
                                    <div class="tc_content">
                                        ...
                                        <h4><a href="{{route('lands.show', $land->slug)}}">
                                                {{$land->title}}
                                            </a></h4>
                                        <p>
                                            {{$land->district_name}} | {{$land->province_name}}
                                        </p>
                                    ...
                                    <div class="fp_footer">
                                        ...
                                        <ul class="fp_meta float-right mb0">
                                            <a class="btn btn-sm btn-outline-primary" href="{{route('lands.show', $land->slug)}}">
                                                View Details
                                            </a>
                                        </ul>
                                    </div>
                    ...
                    <div class="col-lg-12">
                        {{$lands->links('vendor.pagination.new')}}
                    </div>
                </div>
            </div>
        </div>
